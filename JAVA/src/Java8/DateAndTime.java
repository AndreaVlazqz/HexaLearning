    ...
    public static void main(String[] args){
        ...
        switch (monthName){
            ...
            case AUGUST: if (day >= 1 && day<= 22){
                ...
                break;
            case SEPTEMBER: if (day >= 1 && day<= 22){
                System.out.println("The Zodiac sign is: Virgo");
            }
                if (day >= 23 && day<= 30){
